...
int main() {
    ...
    cout << "Skriv inn høyde, bredde og antall miner: " << endl;;
    int height = 20, width = 20, mines = 40;
            ...
            for(int col = 0; col < width; ++col) {
                ...
                if (game->isTileOpen(row, col) || (game->isGameOver() && game->isTileMine(row, col))) {
                    ...
                    if (game->isTileMine(row, col)) {
                        ...
                        if(num_adjacent_mines > 8){
                            cout<<"fant mange miner = " <<num_adjacent_mines<<"på rad "<<row<<" og colonne = " <<col<<endl;
                        }
